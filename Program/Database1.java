...
public class Database1 {
    public static void main(String[] args) {
        ...
        Pokemon[] pokedex = new Pokemon[151];
        {
            ...
            pokedex[80] = new Pokemon("Magnemite", "Electric/Steel", "081", 25, 35, 95, 70, 55, 45, "Magnet Pull", "Sturdy", "Analytic", "Uses anti-gravity to stay suspended. Appears without warning and uses THUNDER WAVE and similar moves.", "Magneton", "Evolves at Lvl 30");
            pokedex[81] = new Pokemon("Magneton", "Electric/Steel", "082", 50, 60, 120, 95, 70, 70, "Magnet Pull", "Sturdy", "Analytic", "Formed by several MAGNEMITEs linked together. They frequently appear when sunspots flare up.", "does not evolve", " ");
