...
public class Pokemon {
    ...
    public Pokemon(String name, String type, String dexNumber, int HP, int ATTK, int spATTK, int DEF, int spDEF, int SPEED, String description, String evolution, String evoMethod) {
        this.name = name;
        this.type = type;
